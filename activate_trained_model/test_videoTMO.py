...
def run_trained_model(args):
    ...
    net_path = os.path.join(args.model_path, "net_epoch10_iter124.pth")
...
def run_model_on_path(model_params, device, net_path, input_images_path, output_images_path,
    ...
    #scenes = ['exhibition_area_light','fishing_longshot_02']
    #scenes = ['Cleaning-3Exp-2Stop']
    for scene in scenes:
        ...
        model_save_util.run_model_on_video(net_G, im_paths, device, im_names, output_images_path,
